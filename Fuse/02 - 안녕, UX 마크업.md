...
-----------
네이티브 테마와 함께 데스크탑 프리뷰에서도 보여지도록 하려면, NativeWithFallback 테마를 사용하면 됩니다. 이렇게 하면 iOS와 Android에서는 네이티브 콘트롤을, 데스크탑에서는 기본 테마를 보여줍니다.
-----------
